...
f7_K <- read.cross(format = "csv", file ="F7_Kmap3.asmapIN.csv", F.gen = 7, genotypes = c("A", "HET", "B"))
f7_K <- convert2riself(f7_K)
f7_K <- pullCross(f7_K, type = "co.located")
f7_K

#set bychr = FALSE to allow complete reconstruction of map 
map4 <- mstmap(f7_K, pop.tpye = "ARIL", bychr = F, dist.fun = "kosambi", trace = TRUE, detectBadData = T, p.value = 1e-09, , mvest.bc = TRUE, return.imputed = T)
