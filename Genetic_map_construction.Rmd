...
abh <- readABHgenotypes("/home/mmoser/Tools/repositories/GBS2map/test.abh.input", nameA = "A", nameB = "B")
...
writeABHgenotypes(pes, "/home/mmoser/Tools/repositories/GBS2map/test.abh.output")




f7_K <- read.cross(format = "csv", file ="/home/mmoser/Tools/repositories/GBS2map/test.abh.output", F.gen = 7, genotypes = c("A", "HET", "B"))
f7_K <- convert2riself(f7_K)
f7_K <- pullCross(f7_K, type = "co.located")
f7_K
